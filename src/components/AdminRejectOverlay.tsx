...
const AdminRejectOverlay: React.FC<EditItemOverlayProps> = ({ visible, sectionName, onCancel, onConfirm }) => {
    ...
    >
      <View style={styles.overlay}>
        <Animated.View style={[styles.container, { transform: [{ scale: scaleValue }] }]}>
          <Text style={styles.title}>⚠️ Confirm Item Deletion</Text>
...
export default AdminRejectOverlay;
