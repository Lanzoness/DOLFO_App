        ...
        <View style={styles.container}>
          <View style={styles.topContainer}>
            ...
            <TouchableHighlight
              style={[
                styles.uploadButton,
                { backgroundColor: buttonPressed ? UserPalette.active_button : UserPalette.blue },
              ]}
          ...
          <View style={styles.formContainer}>
            <View style={styles.formContentPlaceholder}>
              ...
              <TouchableHighlight
                style={[
                  styles.uploadButton,
                  { backgroundColor: buttonPressed ? UserPalette.active_button : UserPalette.secondary_blue },
                ]}
                underlayColor={UserPalette.active_button}
                onShowUnderlay={() => setButtonPressed(true)}
                onHideUnderlay={() => setButtonPressed(false)}
...
export default AdminSubmitLost;
